...
swap the FFmpeg packages for `libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev`
on Debian/Ubuntu (or `gstreamer1-devel gstreamer1-plugins-base-devel` on Fedora).
